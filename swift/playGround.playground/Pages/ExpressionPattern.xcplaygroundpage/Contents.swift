...
let puzzleInput = "great minds think alike123"
var puzzleOutput = ""
let vowels: [Character] = ["a","e","i","o","u", " "]
for chracter in puzzleInput {
    switch chracter {
    case vowels:
        print("contains \(chracter)")
    case "m":
        print("mmmmmmm")
    case "0" ... "9":
        print(chracter)
//    case CharacterSet.alphanumerics
//        print("continas \(chracter)")
    default:
        print("not contains \(chracter)")
    }
}
//for chracter in puzzleInput {
//    switch chracter {
//    case _ where vowels.contains(chracter):
//        print("contains \(chracter)")
//    default:
//        print("not contains \(chracter)")
//    }
